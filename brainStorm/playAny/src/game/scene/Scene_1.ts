class Scene_1 extends BaseScene{
    constructor(){
        super();
        this.init();
    }
    ...
    private init(){
        let engine = Matter.Engine.create({enableSleeping:true},null);
        ...
        //事件相关
        Matter.Events.on(world,'afterAdd',(evt)=>{
        ...
        Matter.Events.on(engine,'collisionActive',(evt)=>{
        ...
        let circle = Matter.Bodies.circle(250,50,50,{
            restitution:1,
            render:{
                fillStyle:0xFFFF00
            }
        ...
        let rect = Matter.Bodies.rectangle(200,300,350,50,{
            restitution:1,
            render:{
                fillStyle:0xFFFF00
            }
        ...
        let ground = Matter.Bodies.rectangle(360,1260,720,50,{
            isStatic:true,
            render:{
                sprite:gsh
            }
