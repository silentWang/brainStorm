...
//营救公主
var Scene_3 = (function (_super) {
    __extends(Scene_3, _super);
    function Scene_3() {
    ...
    //bdfore update
    Scene_3.prototype.beforeUpdateHandle = function (evt) {
        if (!this.isRunning)
            return;
    ...
    //collisionStart
    Scene_3.prototype.collisionHandle = function (evt) {
        var pairs = evt.pairs;
    ...
    //创建敌人加碰撞过滤
    Scene_3.prototype.createEnemy = function (xx, yy, category, num) {
    ...
    Scene_3.prototype.exit = function () {
...
__reflect(Scene_3.prototype, "Scene_3");
//# sourceMappingURL=Scene_3.js.map